...
PFNGLNAMEDSTRINGARBPROC glNamedString;
PFNGLDELETENAMEDSTRINGARBPROC glDeleteNamedString;
PFNGLCOMPILESHADERINCLUDEARBPROC glCompileShaderInclude;
PFNGLISNAMEDSTRINGARBPROC glIsNamedString;
PFNGLGETNAMEDSTRINGARBPROC glGetNamedString;
PFNGLGETNAMEDSTRINGIVARBPROC glGetNamedStringiv;
#ifdef _DEBUG
int loadgl() {
	int result = 0;
	...
	glNamedString = (PFNGLNAMEDSTRINGARBPROC)wglGetProcAddress("glNamedStringARB");
	if(!glNamedString) { MessageBox(0, "Couldn't load OpenGL extension shading_language_include, function \"glNamedStringARB\" is missing.", "OpenGL function missing" , MB_OK); result = -1; }

	glDeleteNamedString = (PFNGLDELETENAMEDSTRINGARBPROC)wglGetProcAddress("glDeleteNamedStringARB");
	if(!glDeleteNamedString) { MessageBox(0, "Couldn't load OpenGL extension shading_language_include, function \"glDeleteNamedStringARB\" is missing.", "OpenGL function missing" , MB_OK); result = -1; }

	glCompileShaderInclude = (PFNGLCOMPILESHADERINCLUDEARBPROC)wglGetProcAddress("glCompileShaderIncludeARB");
	if(!glCompileShaderInclude) { MessageBox(0, "Couldn't load OpenGL extension shading_language_include, function \"glCompileShaderIncludeARB\" is missing.", "OpenGL function missing" , MB_OK); result = -1; }

	glIsNamedString = (PFNGLISNAMEDSTRINGARBPROC)wglGetProcAddress("glIsNamedStringARB");
	if(!glIsNamedString) { MessageBox(0, "Couldn't load OpenGL extension shading_language_include, function \"glIsNamedStringARB\" is missing.", "OpenGL function missing" , MB_OK); result = -1; }

	glGetNamedString = (PFNGLGETNAMEDSTRINGARBPROC)wglGetProcAddress("glGetNamedStringARB");
	if(!glGetNamedString) { MessageBox(0, "Couldn't load OpenGL extension shading_language_include, function \"glGetNamedStringARB\" is missing.", "OpenGL function missing" , MB_OK); result = -1; }

	glGetNamedStringiv = (PFNGLGETNAMEDSTRINGIVARBPROC)wglGetProcAddress("glGetNamedStringivARB");
	if(!glGetNamedStringiv) { MessageBox(0, "Couldn't load OpenGL extension shading_language_include, function \"glGetNamedStringivARB\" is missing.", "OpenGL function missing" , MB_OK); result = -1; }
...
int loadgl() {
	...
	if(
			...
			glNamedString == nullptr ||
			glDeleteNamedString == nullptr ||
			glCompileShaderInclude == nullptr ||
			glIsNamedString == nullptr ||
			glGetNamedString == nullptr ||
			glGetNamedStringiv == nullptr ||
			false ) {
		MessageBox(0, "Couldn't load OpenGL 4.5 and shading_language_include!", "OpenGL function missing" , MB_OK); 
 		return -1;
	}
	return 0; 
}
